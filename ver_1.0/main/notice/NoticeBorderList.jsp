...
<body>
	<div class='menuBar'>
		...
		<a href="NoticeBorderList.jsp">공지사항 </a> | <a href="QnABorderList.jsp">QnA
			게시판</a>
		...
		<div class='noticeTitle'>
			...
			<table border="1">
				...
				<thead align="center">
					...
					<tr>
						<td align="left">
							<!-- 관리자만 이용이 가능합니다. --> <input type="button" value="글 입력"
							onclick="location='NoticeBorderInsert.jsp'">

						</td>

						<td align="right" colspan="2"><input type="search"
							id="mySearch" name="mySearch" value="idSerch"> <input
				...
				<tr>
					...
					<td width="700px"><a href="NoticeTextView.jsp?count1=<%=i%>"><%=noticeBean.getNo_title()%></a>
					</td>
