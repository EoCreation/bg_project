...
<body>
	<div class='menuBar'>
		...
		<a href="../index.jsp">Home</a> | <a
			href="../notice/NoticeBorderList.jsp">공지사항 </a> | <a
			href="../qna/QnABorderList.jsp">QnA 게시판</a>
			...
			<table border="1">
				...
				<thead align="center">
					...
					<tr>
						<td align="left"><input type="button" value="글 입력"
							onclick="location.href='QnABorderInsert.jsp'"></td>
						<td></td>
				...
				<%
					...
					for (int i = 0; i < vc.size(); i++) {
						...
						session.setAttribute("return" + i, qnABean.getTextReturn());
